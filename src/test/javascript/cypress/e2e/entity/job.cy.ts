...
describe('Job e2e test', () => {
  ...
  const jobSample = {
    jobTitle: 'Coordinateur des infrastructures mondial',
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type("Developpeur de l'optimisation national");
      cy.get(`[data-cy="jobTitle"]`).should('have.value', "Developpeur de l'optimisation national");

      cy.get(`[data-cy="minSalary"]`).type('7295.92');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '7295.92');

      cy.get(`[data-cy="maxSalary"]`).type('19555');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '19555');

      cy.get(`[data-cy="subSalary"]`).type('32431.68');
      cy.get(`[data-cy="subSalary"]`).should('have.value', '32431.68');

      cy.get(`[data-cy="totalSalary"]`).type('1208.91');
      cy.get(`[data-cy="totalSalary"]`).should('have.value', '1208.91');

      cy.get(`[data-cy="date"]`).type('2024-09-02');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-09-02');

      cy.get(`[data-cy="codeCode"]`).type('ec1d106d-01d7-459f-a286-c2035aaaf514');
      cy.get(`[data-cy="codeCode"]`).invoke('val').should('match', new RegExp('ec1d106d-01d7-459f-a286-c2035aaaf514'));
