...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'fd2ff9c6-9c5a-48f4-82ce-00057abac1a4' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('3ca1c4a2-5e1e-4b44-aec9-fc0d031c2822');
      cy.get(`[data-cy="name"]`).should('have.value', '3ca1c4a2-5e1e-4b44-aec9-fc0d031c2822');
