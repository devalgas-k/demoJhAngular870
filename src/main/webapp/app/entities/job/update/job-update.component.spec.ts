...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 25832 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 2484 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 22721 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 14889 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 21211 };
      job.tasks = [task];
      const employee: IEmployee = { id: 22346 };
      job.employee = employee;
