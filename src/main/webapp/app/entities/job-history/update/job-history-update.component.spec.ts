...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 13995 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 20448 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 19429 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 24421 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 13468 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 31568 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 31996 };
      jobHistory.job = job;
      const department: IDepartment = { id: 11766 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 31835 };
      jobHistory.employee = employee;
